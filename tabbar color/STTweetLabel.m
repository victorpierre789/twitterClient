...
- (void)setupLabel {
    ...
    _attributesText = @{NSForegroundColorAttributeName: self.textColor, NSFontAttributeName: [UIFont fontWithName:@"Avenir-book" size:16]};
    _attributesHandle = @{NSForegroundColorAttributeName: UIColorFromRGB(0x23426F), NSFontAttributeName: [UIFont fontWithName:@"Avenir-book" size:16]};
    _attributesHashtag = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithWhite:170.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"Avenir-book" size:16]};
    _attributesLink = @{NSForegroundColorAttributeName: [[UIColor alloc] initWithRed:129.0/255.0 green:171.0/255.0 blue:193.0/255.0 alpha:1.0], NSFontAttributeName: [UIFont fontWithName:@"Avenir-book" size:16]};
